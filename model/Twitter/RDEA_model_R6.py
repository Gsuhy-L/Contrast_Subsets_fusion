...
from sampler_R6 import Sampler
...
class Net1(th.nn.Module):
    def __init__(self, hidden_dim, num_k, alpha=0.5, beta=1., gamma=.1):
        ...
        self.encoder = Encoder(5000, hidden_dim, 4)
        # self.sampler = Sampler()
        self.sample_model = Sampler(device, num_k)
        self.extractor = ExtractorMLP(64, False, 0, 1)
        self.local_d = FF(self.embedding_dim*2)  # Feed forward layer
        self.global_d = FF(self.embedding_dim*2)  # Feed forward layer
