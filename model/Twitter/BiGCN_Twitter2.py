...
from RDEA_model2 import Net1, Classfier1
...
def train_GCN(treeDic, x_test, x_train, model_config, UDdroprate,lr, weight_decay,patience,n_epochs,batchsize,dataname,iter,contrast_lr):
    ...
    for epoch in range(n_epochs):
        ...
        for Batch_data in tqdm_train_loader:
            ...
            loss=finalloss+contrast_lr*loss_CrossGraph#contrast_lr*loss_IntraGraph
            opt.zero_grad()
            loss.backward()
...
def run_main(contrast_lr):
    # set_seed(1)
    f = open('/home/ubuntu/PyProjects_gsuhyl/PyProjects/Contrast_Subsets_fusion/'+datasetname+'res2.txt','a')
    test_accs = []
    NR_F1 = []
    FR_F1 = []
    TR_F1 = []
