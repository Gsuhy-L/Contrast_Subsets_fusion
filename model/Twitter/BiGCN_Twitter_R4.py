...
from RDEA_model_R4 import Net1, Classfier1
...
def train_GCN(treeDic, x_test, x_train, model_config, UDdroprate,lr, weight_decay,patience,n_epochs,batchsize,dataname,iter,sample_i):
    ...
    for unsup_epoch in range(25):
        ...
        for Batch_data in tqdm_train_loader:
            ...
            loss = unsup_model(Batch_data, sample_i)
...
def run_main(contrast_lr):
    # set_seed(1)
    f = open('/home/ubuntu/PyProjects_gsuhyl/PyProjects/Contrast_Subsets_fusion/'+datasetname+'res_R4.txt','a')
    test_accs = []
    NR_F1 = []
    FR_F1 = []
    TR_F1 = []
