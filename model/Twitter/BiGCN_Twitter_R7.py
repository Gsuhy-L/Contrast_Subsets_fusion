...
from RDEA_model_R7 import Net1, Classfier1
...
def train_GCN(treeDic, x_test, x_train, model_config, UDdroprate,lr, weight_decay,patience,n_epochs,batchsize,dataname,iter,con_lr):
    ...
    unsup_model = Net1(64, 1, con_lr).to(device)
    unsup_epoch = 0
...
def run_main(head_n):
    # set_seed(1)
    f = open('/home/ubuntu/PyProjects_gsuhyl/PyProjects/Contrast_Subsets_fusion/'+datasetname+'res_R7.txt','a')
    test_accs = []
    NR_F1 = []
    FR_F1 = []
    TR_F1 = []
