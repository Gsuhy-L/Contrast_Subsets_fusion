...
from sampler_R8 import Sampler
...
class Net1(th.nn.Module):
    def __init__(self, hidden_dim, n_head, alpha=0.5, beta=1., gamma=.1):
        ...
        self.encoder = Encoder(5000, hidden_dim, n_head)
        # self.sampler = Sampler()
        self.sample_model = Sampler(device)
        self.extractor = ExtractorMLP(hidden_dim, False, 0, 1)
...
class Classfier1(th.nn.Module):
    ...
    def forward(self, embed, data, states = 'train'):
        #todo
