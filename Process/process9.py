import os
from Process.dataset9 import GraphDataset,BiGraphDataset,UdGraphDataset,BiGraphDataset1
cwd=os.getcwd()
...
def loadBiData1(dataname, treeDic, fold_x_train, fold_x_test, TDdroprate,BUdroprate):
    # data_path = os.path.join(cwd,'data', dataname + 'graph')
    data_path = os.path.join("/home/ubuntu/PyProjects_gsuhyl/PyProjects/RDEA-main-init/RDEA-main/Process",'data',dataname+'graph')
    print("loading train set", )
